...
if __name__ == "__main__":
  ...
  base = '/content/drive/MyDrive/DLH_Final_Project/test1'
  notes = 'Comorbidity/Xml/obesity_patient_records_test.xml'
  # notes = '/content/drive/MyDrive/DLH_Final_Project/test1/Comorbidity/Xml/obesity_patient_records_test.xml'
  xml = 'Comorbidity/Xml/obesity_standoff_annotations_test.xml'
  #xml = '/content/drive/MyDrive/DLH_Final_Project/test1/Comorbidity/Xml/obesity_standoff_annotations_test.xml'
